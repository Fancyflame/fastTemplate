        ...
        if (target.nodeName.toLowerCase() == "template") {
            ...
            if (!tem) {
                if (!parentBinds) {
                    ...
                    if (n) parentBinds = n._ftmBinds;
                    else return;
                }
                readNode(target, parentBinds);
                return;
            }
            {
            ...
            function readNode(node, binds) {
                ...
                if (node.nodeType === 1) {
                    ...
                    node.childNodes.forEach(e => DOMchange(e, binds));
